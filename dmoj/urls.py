...
from judge.views import TitledTemplateView, api, blog, contests, language, license, mailgun, organization, \
    preview, problem, problem_download, problem_manage, ranked_submission, register, stats, status, submission, tag, \
    tasks, two_factor, user, widgets
...
from judge.views.select2 import AssigneeSelect2View, ContestSelect2View, \
    ...
    OrganizationUserSelect2View, ProblemSelect2View, TagGroupSelect2View, TagSelect2View, \
